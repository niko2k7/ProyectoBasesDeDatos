...
GRANT DELETE ON proyecto_base_datos.CLIENTE TO 'rol_gerente'@'localhost';
GRANT DELETE ON proyecto_base_datos.PROOVEDOR TO 'rol_gerente'@'localhost';
GRANT DELETE ON proyecto_base_datos.EMPLEADO TO 'rol_gerente'@'localhost';
GRANT DELETE ON proyecto_base_datos.HORARIO_EMPLEADO TO 'rol_gerente'@'localhost';
...
GRANT DELETE ON proyecto_base_datos.PROOVEDOR TO 'rol_contabilidad'@'localhost';
GRANT DELETE ON proyecto_base_datos.FACTURA_COMPRA TO 'rol_contabilidad'@'localhost';
GRANT DELETE ON proyecto_base_datos.DETALLE_FACTURA_COMPRA TO 'rol_contabilidad'@'localhost';
GRANT DELETE ON proyecto_base_datos.CUENTA_POR_COBRAR TO 'rol_contabilidad'@'localhost';
GRANT DELETE ON proyecto_base_datos.CUENTA_POR_PAGAR TO 'rol_contabilidad'@'localhost';
...
GRANT DELETE ON proyecto_base_datos.SERVICIO TO 'rol_contabilidad'@'localhost';
